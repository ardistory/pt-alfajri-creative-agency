...
.screen:after {
  ...
  */
                ...
                <div class="display_div">
                    <div class="screen_out">
                        <div class="screen_out1">
                            <div class="screen">
                                <span class="notfound_text"> Mohon maaf menu yang anda cari tidak di temukan</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="flex justify-center">
        <x-button label="Kembali Ke Home" class="btn-error bg-red-800 btn-sm rounded-none text-white" link="/" />
    </div>
</div>
