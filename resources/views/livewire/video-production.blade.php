<div>
    ...
    <div class="mb-32">
        <p class="font-semibold text-center text-lg md:text-4xl text-black dark:text-white mb-20">APA KEUNGGULAN <span
    ...
    <div class="flex items-center mb-32">
        ...
        <div>
            <div class="group">
                <p class="text-gray-500 dark:text-white font-bold text-sm md:text-2xl group-hover:text-red-700">
                    Lights, Camera, Action!
                </p>
                <p class="text-gray-500 dark:text-white font-bold text-sm md:text-2xl group-hover:text-black">
