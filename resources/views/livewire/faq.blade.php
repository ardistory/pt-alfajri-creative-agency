<div class="flex justify-center">
    <div class="max-w-4xl mt-10">
        ...
        <div class="grid grid-cols-5 mt-10 gap-5">
            <div class="flex flex-col gap-2 items-start col-span-1">
                <button wire:click="changeTab('ketentuan')"
                    class="text-xs md:text-base font-bold @if ($selectedTab == 'ketentuan') text-gray-400 @endif">
                    Ketentuan File
                </button>
                <button wire:click="changeTab('pesanan')"
                    class="text-xs md:text-base font-bold @if ($selectedTab == 'pesanan') text-gray-400 @endif">
                    Pesanan
                </button>
            </div>

            @if ($selectedTab == 'ketentuan')
